    ...
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-5xl mx-auto bg-white shadow-xl rounded-xl p-10">
        ...
        <div className="flex justify-between items-center mb-10">
          <h1 className="text-4xl font-bold text-gray-800">Institution Profile</h1>
          <button
        ...
        <div className="flex items-center gap-6 mb-10">
          ...
          <div>
            <h2 className="text-3xl font-semibold text-gray-900">{institute.fullname}</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-12">
          ...
          <InfoItem
            label="Subdomain"
            value={<span className="text-blue-700">{institute.subdomain}.educonnect.com</span>}
            />
          <InfoItem
...
const SectionTitle = ({ title }) => (
  <h2 className="text-2xl font-semibold text-gray-800 mb-4 border-b pb-1">{title}</h2>
)
